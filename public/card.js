            ...
            return `<div class="report-card card-fire" id="${det.ReqID}">
                    <div class="report-container">
                        <div class="header">
                            ...
                            <div class="r-date">${new Date(det.ReqTime).toLocaleString().split(',')[0]}</div>
                            <div class="r-id">${det.ReqID.split('-')[0]}-${det.ReqID.split('-')[2]}</div>
                            <div class="tag r-fire tag-type"><i class="bi bi-fire"></i>Fire</div>
                            <div class="tag r-s r-s-o"></div>
                        </div>
                        <div class="discription">
                                <ul>
                                    <li><strong>Request By:</strong><br>&nbsp; ${det.uid}</li>
